...
#ifndef	_X2SuccessfulOutcome_H_
#define	_X2SuccessfulOutcome_H_
...
/* Dependencies */
typedef enum X2SuccessfulOutcome__value_PR {
	X2SuccessfulOutcome__value_PR_NOTHING,	/* No components present */
	X2SuccessfulOutcome__value_PR_HandoverRequestAcknowledge,
	X2SuccessfulOutcome__value_PR_ResetResponse,
	X2SuccessfulOutcome__value_PR_X2SetupResponse,
	X2SuccessfulOutcome__value_PR_ResourceStatusResponse,
	X2SuccessfulOutcome__value_PR_ENBConfigurationUpdateAcknowledge,
	X2SuccessfulOutcome__value_PR_MobilityChangeAcknowledge,
	X2SuccessfulOutcome__value_PR_CellActivationResponse,
	X2SuccessfulOutcome__value_PR_SeNBAdditionRequestAcknowledge,
	X2SuccessfulOutcome__value_PR_SeNBModificationRequestAcknowledge,
	X2SuccessfulOutcome__value_PR_SeNBModificationConfirm,
	X2SuccessfulOutcome__value_PR_SeNBReleaseConfirm,
	X2SuccessfulOutcome__value_PR_X2RemovalResponse,
	X2SuccessfulOutcome__value_PR_RetrieveUEContextResponse,
	X2SuccessfulOutcome__value_PR_SgNBAdditionRequestAcknowledge,
	X2SuccessfulOutcome__value_PR_SgNBModificationRequestAcknowledge,
	X2SuccessfulOutcome__value_PR_SgNBModificationConfirm,
	X2SuccessfulOutcome__value_PR_SgNBReleaseRequestAcknowledge,
	X2SuccessfulOutcome__value_PR_SgNBReleaseConfirm,
	X2SuccessfulOutcome__value_PR_SgNBChangeConfirm,
	X2SuccessfulOutcome__value_PR_ENDCX2SetupResponse,
	X2SuccessfulOutcome__value_PR_ENDCConfigurationUpdateAcknowledge,
	X2SuccessfulOutcome__value_PR_ENDCCellActivationResponse,
	X2SuccessfulOutcome__value_PR_ENDCPartialResetConfirm,
	X2SuccessfulOutcome__value_PR_EUTRANRCellResourceCoordinationResponse,
	X2SuccessfulOutcome__value_PR_ENDCX2RemovalResponse
} X2SuccessfulOutcome__value_PR;

/* X2SuccessfulOutcome */
typedef struct X2SuccessfulOutcome {
	ProcedureCode_t	 procedureCode;
	Criticality_t	 criticality;
	struct X2SuccessfulOutcome__value {
		X2SuccessfulOutcome__value_PR present;
		union X2SuccessfulOutcome__value_u {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} X2SuccessfulOutcome_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_X2SuccessfulOutcome;
extern asn_SEQUENCE_specifics_t asn_SPC_X2SuccessfulOutcome_specs_1;
extern asn_TYPE_member_t asn_MBR_X2SuccessfulOutcome_1[3];

#ifdef __cplusplus
}
#endif

#endif	/* _X2SuccessfulOutcome_H_ */
