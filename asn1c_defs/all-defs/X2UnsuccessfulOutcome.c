...
select_X2UnsuccessfulOutcome_criticality_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	...
	const long *constraining_value = (const long *)((const char *)parent_sptr + offsetof(struct X2UnsuccessfulOutcome, procedureCode));
...
static asn_type_selector_result_t
select_X2UnsuccessfulOutcome_value_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	asn_type_selector_result_t result = {0, 0};
	const asn_ioc_set_t *itable = asn_IOS_X2AP_ELEMENTARY_PROCEDURES_1;
	size_t constraining_column = 3; /* &procedureCode */
	size_t for_column = 2; /* &X2UnsuccessfulOutcome */
	size_t row, presence_index = 0;
	const long *constraining_value = (const long *)((const char *)parent_sptr + offsetof(struct X2UnsuccessfulOutcome, procedureCode));
...
static asn_TYPE_member_t asn_MBR_value_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.HandoverPreparationFailure),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.X2SetupFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.ResourceStatusFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.ENBConfigurationUpdateFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.MobilityChangeFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.CellActivationFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.SeNBAdditionRequestReject),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.SeNBModificationRequestReject),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.SeNBModificationRefuse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.X2RemovalFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.RetrieveUEContextFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.SgNBAdditionRequestReject),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.SgNBModificationRequestReject),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.SgNBModificationRefuse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.SgNBReleaseRequestReject),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.SgNBChangeRefuse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.ENDCX2SetupFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.ENDCConfigurationUpdateFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.ENDCCellActivationFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome__value, choice.ENDCX2RemovalFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static asn_CHOICE_specifics_t asn_SPC_value_specs_4 = {
	sizeof(struct X2UnsuccessfulOutcome__value),
	offsetof(struct X2UnsuccessfulOutcome__value, _asn_ctx),
	offsetof(struct X2UnsuccessfulOutcome__value, present),
	sizeof(((struct X2UnsuccessfulOutcome__value *)0)->present),
...
asn_TYPE_member_t asn_MBR_X2UnsuccessfulOutcome_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome, procedureCode),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome, criticality),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Criticality,
		select_X2UnsuccessfulOutcome_criticality_type,
		{ 0, &asn_PER_memb_criticality_constr_3,  memb_criticality_constraint_1 },
		0, 0, /* No default value */
		"criticality"
		},
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct X2UnsuccessfulOutcome, value),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_value_4,
		select_X2UnsuccessfulOutcome_value_type,
		{ 0, &asn_PER_memb_value_constr_4,  memb_value_constraint_1 },
		0, 0, /* No default value */
		"value"
		},
};
static const ber_tlv_tag_t asn_DEF_X2UnsuccessfulOutcome_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_X2UnsuccessfulOutcome_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* procedureCode */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* criticality */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* value */
};
asn_SEQUENCE_specifics_t asn_SPC_X2UnsuccessfulOutcome_specs_1 = {
	sizeof(struct X2UnsuccessfulOutcome),
	offsetof(struct X2UnsuccessfulOutcome, _asn_ctx),
	asn_MAP_X2UnsuccessfulOutcome_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_X2UnsuccessfulOutcome = {
	"X2UnsuccessfulOutcome",
	"X2UnsuccessfulOutcome",
	&asn_OP_SEQUENCE,
	asn_DEF_X2UnsuccessfulOutcome_tags_1,
	sizeof(asn_DEF_X2UnsuccessfulOutcome_tags_1)
		/sizeof(asn_DEF_X2UnsuccessfulOutcome_tags_1[0]), /* 1 */
	asn_DEF_X2UnsuccessfulOutcome_tags_1,	/* Same as above */
	sizeof(asn_DEF_X2UnsuccessfulOutcome_tags_1)
		/sizeof(asn_DEF_X2UnsuccessfulOutcome_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_X2UnsuccessfulOutcome_1,
	3,	/* Elements count */
	&asn_SPC_X2UnsuccessfulOutcome_specs_1	/* Additional specs */
};
